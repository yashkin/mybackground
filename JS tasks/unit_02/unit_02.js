...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; // в данном случае произошла конкатенация строки и числа, поэтому арифметическое вычисление не произошло.
...
function t8() {
    // value всегда получаем внутри функции
     let data10 = document.querySelector('.i-8').value; // получили значение
    // тут выводим
    document.querySelector('.out-8').innerHTML = data10;
}
...
function t9() {
       let data9 = document.querySelector('.i-9').value; // получили значение
    // тут выводим
...
function t10() {
 let data10 = document.querySelector('.i-10').value; // получили значение
    // тут выводим
...
function t11() {
let data11 = document.querySelector('.i-11').value; // получили значение
    // тут выводим
...
function t12() {
    ...
    document.querySelector('.out-12').innerHTML = 'Hello ' + firstName + ' ' + lastName ;
}
...
function t13() {
 let a13 = document.querySelector('.i-13-1').value;
let b13 = document.querySelector('.i-13-2').value;
    document.querySelector('.out-13').innerHTML = +a13 + +b13;
}
...
function t14() {
    document.querySelector('.i-14').value = 'Go'; // получили значение
