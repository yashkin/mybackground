...
function f11() {
    ...
    out11.innerHTML = d11.indexOf(+i11.value)
...
function f17() {
   for (let i = 0; i <= d171.length-1; i++) {
    
        d17.push(d171[i]);
    }
    
    for (let i = 0; i <= d172.length-1; i++) {
...
function f18() {
    ...
    out.innerHTML = d18.includes(i18);
}
