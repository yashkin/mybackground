...
const f7 = () => {
    ...
    let b = new Set(password); 
    if (password.length === b.size && password.length > 6)
    {
        out = 1;
    }
    else
...
const f10 = (out_set, elem) => {
    ...
    document.querySelector('.out-10').innerHTML = elem;
}
...
const f12 = () => {
    let bArr = Array.from(str12);
    let s12 = new Set(bArr)
