...
function f4(){
   let age1 = document.querySelector('.i-4').value; 
...
function f7() {
      ...
      let num7 = document.querySelector('.i-71').value;
      let num8 = document.querySelector('.i-72').value;
      let out7 = document.querySelector('.out-7');
      out7.innerHTML = Math.pow(num7, num8); 
}
...
function f10() {
   let num10 = document.querySelector('.s-100').value;
...
function f11(){
   let num11 = document.querySelector('.s-110').value;  let num10 = document.querySelector('.s-100').value;
...
function f13(){
   let v13 = i130.value;
   document.querySelector('.out-13').innerHTML = (typeof v13);
}
...
let i142 = +document.querySelector('.i-142').value;
   let num14 = document.querySelector('.s-143').value;
...
function f15(){
   ...
   let i151 = +document.querySelector('.s-151').value;
   let i152 = +document.querySelector('.s-152').value;
   let num15 = document.querySelector('.s-153').value;
